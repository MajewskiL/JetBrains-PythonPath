...
#print(principal,payment,periods,interest)
...
if bug == True:
    ...
    if type == "annuity":
        if principal == 0:
            ...
            print(math.ceil((credit * periods) - principal), math.trunc(principal))
        elif payment == 0:
            credit = annuity_payment(principal,interest,periods)
            principal = credit_principal(credit,interest,periods)
            print(math.trunc((math.ceil(credit) * periods) - principal), math.ceil(credit))
        elif periods == 0:
            periods = years(payment,principal,interest)
            print(math.ceil(periods / 12))
